...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="age" type="text" class="form-control" style="width: auto;" name="age" value="{{ old('age') }}" required autocomplete="age">
                                    <option></option>
...
<div class="form-check form-check-inline">
 ...
 <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="abfmnumber" type="text" class="form-control" name="abfmnumber" value="{{ old('abfmnumber') }}" required autocomplete="abfmnumber">
                            </div>
                        </div>
